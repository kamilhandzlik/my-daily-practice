...
rowcased
https://www.codewars.com/kata/5cb5ebc403c3ff477840393a/train/python
"""
...
def anagrams(subjects, memories, players):
    ...
    for i, subject in enumerate(subjects):
        ...
        ana1 = set()
        for w in mem1:
            if w != subject and sorted(w) == s_sorted:
                ana1.add(w)

        score1 += 2 * len(ana1)

        for w in mem2:
            if w != subject and sorted(w) == s_sorted and w not in ana1:
                score2 += 3
