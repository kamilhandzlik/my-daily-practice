...
def triple_double(num1, num2):
    s1 = [i for i in range(0, 10) if str(i) * 3 in str(num1)]
    s2 = [i for i in range(0, 10) if str(i) * 2 in str(num2)]
...
def triple_double(num1, num2):
    s1, s2 = str(num1), str(num2)
    return int(any(d * 3 in s1 and d * 2 in s2 for d in "0123456789"))
